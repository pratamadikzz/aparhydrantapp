...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        $query = "SELECT * FROM data_hydrant  ORDER BY id ASC";
        ...
        $code_apar = $row['code_hydrant']; // Pastikan 'code_apar' adalah kolom yang ada di tabel Anda
        ?>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <div class="qr-card">
                                            <div class="qr-details">
                                                ...
                                                <input type="hidden" class="qr-code" value="<?php echo $row['code_hydrant']; ?>">
                        
                                                <span class="qr-lokasi"> <?php echo htmlspecialchars($row['lokasi']); ?></span><br>
                                                <span class="qr-departemen"> <?php echo htmlspecialchars($row['jenis_lokasi']); ?></span><br>
                                                <div id="qrcode-<?php echo $row['code_hydrant']; ?>"></div>
                                                <canvas id="canvas-<?php echo $row['code_hydrant']; ?>" width="800" height="600" style="display:none;"></canvas>
                                                <button class="btn btn-success download-btn" data-code="<?php echo $row['code_hydrant']; ?>">Download as Image</button>
                                            </div>
                                        </div>
                                        <hr>
                                    <?php } ?>
                ...
                for (var i = 0; i < cards.length; i++) {
                    ...
                    setTimeout((function(canvas, qrcodeDiv, qrCode, card) {
                        return function() {
                            ...
                            cardImage.src = "assets/img/kartuhydrant2.png";
