...
if ($filter === 'expired') {
    ...
    $query .= "WHERE e.kondisi = 'Rusak'";
} elseif ($filter === 'expired_damaged') {
    $query .= "WHERE e.tanggal_expired < CURDATE() AND e.kondisi = 'Rusak'";
}
        ...
        <div class="data-tables datatable-dark">
            <div class="mb-3">
                ...
                <select id="filter" class="form-control" onchange="filterData()">
                    ...
                    <option value="damaged" <?php if ($filter === 'damaged') echo 'selected'; ?>>Damaged</option>
                    <option value="expired_damaged" <?php if ($filter === 'expired_damaged') echo 'selected'; ?>>Expired & Damaged</option>
                </select>
            </div>
