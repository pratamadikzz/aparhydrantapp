...
if (isset($_GET['code'])) {
    ...
    $query = "SELECT da.code_apar, l.lokasi, d.departemen
              FROM data_apar da
        ...
        setTimeout(function() {
            ...
            cardImage.onload = function() {
                ...
                qrImg.onload = function() {
                    ...
                    // Set text properties
                    context.font = "20px Arial"; // Increased font size
                    ...
                    context.fillText(namaDepartmentText, valueX, baseY + lineHeight * 2);
