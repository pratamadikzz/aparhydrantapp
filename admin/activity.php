...
<head>
    ...
    <title>Cek Apar - Aktivitas Pengguna</title>
                                        ...
                                        <table id="example" class="display" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="background-color:yellow; text-align: center;">Aktivitas</th>
                                                </tr>
                                            </thead>
                                            <tbody style="background-color:white;">
                                                ...
                                                ?>
                                                    <tr >
                                                        ...
                                                        <td><?php echo $row['keterangan'], $row['code_apar'] ," ",",Di Hari ",$row['tanggal']; ?></td>
                                                    </tr>
                                                <?php
                                                    $no++;
                                                }
