...
<head>
    ...
    <title>Cek Apar | Hydrant - Departemen</title>
                                        ...
                                        <table id="example" class="display" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="background-color:yellow;">Nama Departemen</th>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="needs-validation" action="proses/departemen/proses_edit_departemen.php" method="post">
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-3">
                                                                            <label for="firstName">Departemen</label>
                                                                            <input type="text" class="form-control" name="departemen" id="firstName" placeholder="" value="<?php echo $row['departemen']; ?>" required="">
                                                                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>" />
                                                                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>" />
                                                                                <input type="hidden" name="activity" id="activity" value="<?php echo $user_details['nama'] ?> Telah Melakukan Pengeditan Departemen ">
                                                ...
                                                <div class="modal fade" id="<?php echo $hapus_modal_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="needs-validation" action="proses/departemen/proses_hapus.php" method="post">
                                                                        <div class="row">
                                                                            <div class="col-md-12 mb-3">
                                                                            ...
                                                                            <input type="hidden" name="activity" id="activity" value="<?php echo $user_details['nama'] ?> Telah Melakukan Penghapusan Departemen ">
                                                                            <input type="hidden" name="tanggal" id="tanggal" value="<?php echo $dayName . ', ' . date('d-m-Y H:i:s') ?>">
...
<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Departemen</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="needs-validation" action="proses/departemen/proses_tambah_departemen.php" method="post">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="firstName">Nama Departemen</label>
                            <input type="text" class="form-control" name="departemen" id="firstName" placeholder="" value="" required="">
                            <div class="invalid-feedback">
                                Valid first name is required.
                            </div>
                        </div>
                        ...
                        ?>
                            ...
                            <input type="hidden" name="activity" id="activity" value="<?php echo $row['nama'] ?> Telah Melakukan Penambahan Departemen ">
                            <input type="hidden" name="tanggal" id="tanggal" value="<?php echo $dayName . ', ' . date('d-m-Y H:i:s') ?>">
