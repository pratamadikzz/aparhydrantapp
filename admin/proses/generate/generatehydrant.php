                    ...
                    <div class="container">
                        <div class="header">
                            ...
                            <center>
                                ...
                                <span id="code_apar_value" style="display: none;"><?php echo htmlspecialchars($row['code_hydrant']); ?></span>
                                <span id="lokasi_value" style="display: none;"><?php echo htmlspecialchars($row['lokasi']); ?></span>
                                <span id="departemen_value" style="display: none;"><?php echo htmlspecialchars($row['jenis_lokasi']); ?></span>
...
function generateQRCode() {
    ...
    if (qrInput.value.length > 0) {
        ...
        setTimeout(function() {
            ...
            cardImage.src = "../../../assets/img/hydrantcard.png";
            cardImage.onload = function() {
                ...
                qrImg.onload = function() {
                    const qrX = canvas.width - qrImg.width - 418;
                    const qrY = 170;
                    ...
                    const codeHydrant = document.getElementById('code_apar_value').innerText.trim();
                    const lokasi = document.getElementById('lokasi_value').innerText.trim();
                    const jenisLokasi = document.getElementById('departemen_value').innerText.trim();

                    // posisi konsisten
                    const valueX = 645;       // sejajar rata kiri
                    const lineHeight = 30;
                    const maxWidth = 150;    // biar wrap kalau panjang

                    // posisi Y masing-masing sesuai label di kartu
                    const yCode = 248;
                    const yLokasi = 295;
                    const yJenisLokasi = 448;

                    // Code Hydrant
                    context.fillText(codeHydrant, valueX, yCode);

                    // Lokasi (pakai wrapText biar ga kepotong)
                    wrapText(context, lokasi, valueX, yLokasi, maxWidth, lineHeight);

                    // Jenis Lokasi
                    context.fillText(jenisLokasi, valueX, yJenisLokasi);
