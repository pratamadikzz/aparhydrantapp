...
<head>
  ...
  <title>Cek Apar - Scan Barcode</title>
        ...
        <div class="page-inner">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="scanResultModalLabel">Data Apar</h5>
                    ...
                    <form action="proses/apar/proses_scan.php" method="post">
                      ...
                      $dayName = $days[date('l')];
                        ...
                        ?>
                          ...
                          <input type="hidden" class="form-control" name="nama" id="nama" value="<?php echo $row['nama'] ?>">
                          
                       <input type="hidden" name="activity" id="activity" value="<?php echo $row['nama'] ?> Telah Melakukan Scan Pada Apar ">
                       <input type="hidden" name="tanggal" id="tanggal" value="<?php echo $dayName . ', ' . date('d-m-Y H:i:s') ?>">
                        ...
                        <input type="hidden" class="form-control" name="keterangan" id="keterangan" value="Sudah Inspeksi">
          ...
          <script>
            function onScanSuccess(decodedText, decodedResult) {
              // Encode the scanned result for use in the URL
              const encodedText = encodeURIComponent(decodedText);

              // Fetch data from the server using AJAX
              fetch(`get_apar_data.php?code_apar=${encodedText}`)
                .then(response => response.json())
                .then(data => {
                  // Fill the form fields with the received data
                  document.getElementById('id').value = data.id;
                  document.getElementById('codeApar').value = data.code_apar;
                  document.getElementById('lokasi').value = data.lokasi;
                  document.getElementById('departemen').value = data.departemen;
                  document.getElementById('vendor').value = data.vendor;
                  document.getElementById('jenisApar').value = data.jenis_apar;
                  document.getElementById('berat').value = data.berat;
                  document.getElementById('tanggalPenggantian').value = data.tanggal_penggantian;
                  document.getElementById('tanggalRefill').value = data.tanggal_refill; // Set tanggal_refill
                  document.getElementById('tanggalExpired').value = data.tanggal_expired; // Set tanggal_expired

                  // Set the radio buttons based on the received data
                  setRadioButton('kondisi', data.kondisi);
                  setRadioButton('masa_pemakaian', data.masa_pemakaian);
                  setRadioButton('nozzle', data.nozzle);
                  setRadioButton('tabung', data.tabung);
                  setRadioButton('presure', data.presure);
                  setRadioButton('catridge', data.catridge);
                  setRadioButton('pin', data.pin);
                  setRadioButton('handle', data.handle);
                  ...
                  $('#closeButton').click(function() {
                    // Kosongkan nilai-nilai form jika diperlukan
                    document.getElementById('berat').value = '';
                    document.getElementById('tanggalRefill').value = ''; // Clear tanggal_refill
                    document.getElementById('tanggalExpired').value = ''; // Clear tanggal_expired
